...
export const PEEC_READ_TOOLS: PeecTool[] = [
  ...
  { slug: "list_brands",          kind: "read", label: "List brands",          description: "Lists tracked brands (your own + competitors).", params: ["limit", "offset"] },
  { slug: "list_topics",          kind: "read", label: "List topics",          description: "Lists topic groupings. Each prompt belongs to one topic.", params: ["limit", "offset"] },
  ...
  { slug: "list_prompts",         kind: "read", label: "List prompts",         description: "Lists prompts. Filter by topic or tag.", params: ["topic_id", "tag_id", "limit", "offset"] },
  ...
  { slug: "get_brand_report",     kind: "read", label: "Brand report",         description: "Visibility, sentiment, position, share of voice across AI engines.", params: ["start_date", "end_date", "dimensions", "filters"] },
  { slug: "get_domain_report",    kind: "read", label: "Domain report",        description: "Source domain retrieval + citation metrics.", params: ["start_date", "end_date", "dimensions", "filters"] },
  { slug: "get_url_report",       kind: "read", label: "URL report",           description: "URL-level retrieval + citation metrics.", params: ["start_date", "end_date", "dimensions", "filters"] },
